...
class CELLULAR_PANEL_API OverlayPanel /* not final */ : public BackedPanel {
public:
...
struct CELLULAR_PANEL_API DCUnchanger {
public:
   DCUnchanger() {}
...
class CELLULAR_PANEL_API ADCChanger : public std::unique_ptr<wxDC, ::DCUnchanger>
{
