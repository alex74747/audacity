 ...
 * changed if required
 */
class HELP_SYSTEM_API HelpSystem
{
public:
...
HELP_SYSTEM_API void OpenInDefaultBrowser(const URLString& link);
...
class HELP_SYSTEM_API LinkingHtmlWindow final : public HtmlWindow
{
 public:
...
extern HELP_SYSTEM_API ChoiceSetting
     GUIManualLocation
;
