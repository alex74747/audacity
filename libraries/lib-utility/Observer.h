...
public:
   ...
   /*!
    ...
    @tparam Tag exists only so that it can be sometimes explicitly given in
    angle brackets at the point of call, to work around a Windows linker bug
    that makes incorrect duplicate symbol errors
   ...
   template<typename Tag = void,
      typename Object, typename Return, typename... Args>
   Subscription Subscribe(
      Object &obj, Return (Object::*callback)(Args...))
   {
      return Subscribe<Tag>( [&obj, callback](const Message &message){
