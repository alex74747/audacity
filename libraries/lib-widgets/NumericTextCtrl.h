...
DECLARE_EXPORTED_EVENT_TYPE(WIDGETS_API, EVT_TIMETEXTCTRL_UPDATED, -1);
DECLARE_EXPORTED_EVENT_TYPE(WIDGETS_API, EVT_FREQUENCYTEXTCTRL_UPDATED, -1);
DECLARE_EXPORTED_EVENT_TYPE(WIDGETS_API, EVT_BANDWIDTHTEXTCTRL_UPDATED,
                            -1);
...
class WIDGETS_API NumericConverter /* not final */
{
public:
...
class WIDGETS_API NumericTextCtrl final
