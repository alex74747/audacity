...
class WIDGETS_API NumValidatorBase /* not final */ : public wxValidator
{
public:
...
class WIDGETS_API IntegerValidatorBase /* not final */
...
class WIDGETS_API FloatingPointValidatorBase /* not final */
   : public NumValidatorBase
{
public:
...
WIDGETS_API double RoundValue(int precision, double value);
