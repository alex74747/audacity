...
#include "MacroMagic.h"
   ...
   DEFINE_IMAGE( bmpSpectralBrush, wxImage( 27, 27 ), L"SpectralBrush");
...
#define LOGOWITHNAME_HEIGHT 200
   ...
   DEFINE_COLOUR( clrEnvelope,             wxColour( 110, 110, 220),  L"EnvelopeColour" );
   ...
   DEFINE_COLOUR( clrRulerRecordingPen,    wxColour(   128,128,128),  L"RulerRecordingPen" ); // unused
   DEFINE_COLOUR( clrRulerPlaybackBrush,   wxColour(   190,129,129),  L"RulerPlaybackBrush" ); // unused
   DEFINE_COLOUR( clrRulerPlaybackPen,     wxColour(   176,  0, 28),  L"RulerPlaybackPen" ); // unused
   ...
   DEFINE_COLOUR( clrClipAffordanceOutlinePen,    wxColour(    0,    0,    0),  L"ClipAffordanceOutlinePen" );
   DEFINE_COLOUR( clrClipAffordanceInactiveBrush, wxColour(  219,  219,  219),  L"ClipAffordanceUnselectedBrush" );
   DEFINE_COLOUR( clrClipAffordanceActiveBrush,   wxColour(  237,  237,  237),  L"ClipAffordanceSelectedBrush" );
   DEFINE_COLOUR( clrClipAffordanceStroke,        wxColour(  255,  255,  255),  L"ClipAffordanceStroke" );

   DEFINE_COLOUR( clrLabelTrackTextSelection, wxColour(183, 202, 226), L"LabelTrackTextSelection" );

   DEFINE_COLOUR( clrClipNameText,          wxColour(0, 0, 0),       L"ClipNameText" );
   DEFINE_COLOUR( clrClipNameTextSelection, wxColour(183, 202, 226), L"ClipNameTextSelection" );
