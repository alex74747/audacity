...
void MousePrefs::CreateList()
{
   ...
   AddItem(_("Ctrl-Left-Drag"),       _("Select"), _("Scrub"));
   AddItem(_("Ctrl-Shift-Left-Drag"), _("Select"), _("Seek"));
#endif
#ifdef EXPERIMENTAL_SCRUBBING_MIDDLE_MOUSE
   AddItem(_("Middle-Drag"),              _("Select"), _("Scrub by position"));
   AddItem(_("Shift-Middle-Drag"),        _("Select"), _("Seek by position"));
   AddItem(_("Middle-Double-Click-Drag"),       _("Select"), _("Scrub by speed"));
...
#ifdef EXPERIMENTAL_SCRUBBING_MIDDLE_MOUSE
   AddItem(_("Middle-Drag"),                    _("Select"), _("Scrub by position"), _("same as select tool"));
   AddItem(_("Shift-Middle-Drag"),              _("Select"), _("Seek by position"), _("same as select tool"));
   AddItem(_("Middle-Double-Click-Drag"),       _("Select"), _("Scrub by speed"), _("same as select tool"));
