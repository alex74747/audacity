...
wxString WrappedType::ReadAsString()
{
   ...
   case eWrappedString:
      ...
      break;
   case eWrappedInt:
      return wxString::Format(L"%i",*mpInt );
      break;
   case eWrappedDouble:
      return wxString::Format(L"%.8g",*mpDouble );
      break;
   case eWrappedBool:
      return (* mpBool) ? L"true" : L"false";
      break;
   case eWrappedEnum:
      wxASSERT( false );
      break;
   ...
   return L"ERROR"; //Compiler pacifier
}
...
bool WrappedType::ReadAsBool()
{
   ...
   {
   case eWrappedString:
      return mpStr->IsSameAs( L"true", false ); // case free comparison.
      break;
   case eWrappedInt:
      return  *mpInt != 0;
      break;
...
void WrappedType::WriteToAsString( const wxString & InStr)
{
   ...
   case eWrappedDouble:
      *mpDouble = Internat::CompatibleToDouble( InStr );
      break;
   case eWrappedBool:
      *mpBool = InStr.IsSameAs( L"true", false ); // case free comparison.;
      break;
   case eWrappedEnum:
      wxASSERT( false );
      break;
...
void WrappedType::WriteToAsInt( const int InInt)
{
   ...
   {
   case eWrappedString:
      *mpStr = wxString::Format( L"%i", InInt );
      break;
   case eWrappedInt:
      *mpInt = InInt;
      break;
...
void WrappedType::WriteToAsDouble( const double InDouble)
{
   ...
   {
   case eWrappedString:
      *mpStr = wxString::Format( L"%.8g", InDouble );
      break;
   case eWrappedInt:
      *mpInt = (int)InDouble;
      break;
