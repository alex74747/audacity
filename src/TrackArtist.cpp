...
{
   static const float middleC = 293.6647679f;
   ...
   case SpectrogramSettings::grid31Bands:
   {
      ...
      if (bands < 0)
         return -1;
      return (20 / binUnit) *
         pow(10, std::min(31.0f, floor(bands)) / 10);
   }
                                   ...
                                   const ZoomInfo &zoomInfo)
{
   ...
   && findNotesQuantize==findNotesQuantizeOld
      ...
      // Update the spectrum pixel value cache
...
void TrackArtist::DrawWaterfallTimeslice(WaveTrackCache &waveTrackCache, WaveClip *clip,
