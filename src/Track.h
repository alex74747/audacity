...
public:
   ...
   virtual void PasteOver( double t0, double t1,
      const Track *src, double duration,
   ...
   struct Dispatcher {
      ...
      struct Switch< Tag, R, ConcreteType, std::tuple<BaseClass, BaseClasses...> >
      {
         ...
         static constexpr bool Compatible =
            std::is_base_of<BaseClass, ConcreteType>::value;
...
class AUDACITY_DLL_API TrackTypeRegistry {
   struct AUDACITY_DLL_API Item final : Registry::SingleItem {
