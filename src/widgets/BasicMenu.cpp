...
Handle::Handle( Handle &&other )
   : mpImpl{ std::make_unique<Impl>( move( other.mpImpl->muMenu ) ) }
{}
...
{
   return x.mpPosition->mwMenu == y.mpPosition->mwMenu &&
...
{
   return x.mpPosition->mwMenuBar == y.mpPosition->mwMenuBar &&
