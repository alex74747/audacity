/**********************************************************************
  ...
  Paul Licameli split this from Mixer.h
...
#ifndef __AUDACITY_MIXER__
#define __AUDACITY_MIXER__
...
class AUDACITY_DLL_API Mixer {
 public:
   ...
   Mixer(const std::vector< std::shared_ptr<const WaveTrackData> > &inputTracks,
         bool mayThrow,
