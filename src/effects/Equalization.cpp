   ...
   , mFilterFuncI{ windowSize }
{
   ...
   GetConfig(GetDefinition(), PluginSettings::Private,
      GetCurrentSettingsGroup(), L"dBMin", mdBMin, DEF_dBMin);
   GetConfig(GetDefinition(), PluginSettings::Private,
      GetCurrentSettingsGroup(), L"dBMax", mdBMax, DEF_dBMax);
   GetConfig(GetDefinition(), PluginSettings::Private,
      GetCurrentSettingsGroup(), L"DrawMode", mDrawMode, DEF_DrawMode);
   GetConfig(GetDefinition(), PluginSettings::Private,
      GetCurrentSettingsGroup(), L"DrawGrid", mDrawGrid, DEF_DrawGrid);
