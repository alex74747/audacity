...
Param( Sequence,  wxString,   L"Sequence",   (L"" SHORT_APP_NAME),  L"", L"", L"");
...
void EffectDtmf::UpdateUI(void)
{
   ...
   mDtmfSilenceT->SetLabel(_("%.0f ms").Format( dtmfTone * 1000.0));
   ...
   mDtmfToneT->SetLabel(_("%.0f ms").Format( dtmfSilence * 1000.0));
