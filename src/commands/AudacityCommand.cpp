...
PluginPath AudacityCommand::GetPath(){        return BUILTIN_GENERIC_COMMAND_PREFIX + GetSymbol().Internal().GET(); }
...
wxDialogWrapper *AudacityCommand::CreateUI(
   wxWindow *parent, AudacityCommand * WXUNUSED(client))
{
