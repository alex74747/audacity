...
public:
   ...
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#open_project";};
public:
   wxString mFileName;
   bool mbAddToHistory;
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#save_project";};
public:
   wxString mFileName;
   bool mbAddToHistory;
   bool bHasAddToHistory;
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#save_copy";};
public:
   wxString mFileName;
};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#save_log";};
public:
   wxString mFileName;
};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#Clear_log";};
public:
   wxString mFileName;
};
