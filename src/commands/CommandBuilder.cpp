...
struct ShuttleCli final // : public Shuttle
{
   ...
   bool TransferString( const wxString & Name, wxString & strValue, const wxString & WXUNUSED(strDefault) );
   wxString mParams;
...
bool ShuttleCli::TransferString( const wxString & Name, wxString & strValue, const wxString & WXUNUSED(strDefault) )
{
#if 0
   if( !mbStoreInClient )
   {
