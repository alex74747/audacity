...
public:
   ...
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#select_time";};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#select_frequencies";};
...
public:
   ...
   bool Apply(const CommandContext & context) override;
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#select_tracks";};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#select";};
private:
