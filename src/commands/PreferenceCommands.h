...
public:
   ...
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#get_preference";};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#set_preference";};
