...
///
BasicMenu::BarHandle CommandManager::GetMenuBar(const wxString & sMenu)
{
   ...
   const Options &options)
{
...

   {
      ...
      TranslatableLabel labelPrefix;
      if (!mSubMenuList.empty())
         labelPrefix = mSubMenuList.back().text.label.main;
      ...
      entry->labelTop = mCurrentMenuText.label.main;
      entry->finder = finder;
...
constexpr auto JournalCode = L"CM";  // for CommandManager
