...
public:
   ...
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#screenshot_short_format";};
...
private:
   ...
   void CaptureCommands(const CommandContext & Context, const StringArray &Commands  );
...
public:
   ...
   static bool MayCapture( wxDialogWrapper * pDlg );
