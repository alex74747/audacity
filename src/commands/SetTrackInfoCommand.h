...
public:
   ...
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#set_track_status";};
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#set_track_audio";};
   bool ApplyInner( const CommandContext & context, Track * t ) override;
...
public:
   ...
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_I#set_track_visuals";};
   bool ApplyInner( const CommandContext & context, Track * t ) override;
...
public:
   ...
   TranslatableString GetDescription() override {return XO("Sets various values for a track.");};
   // AudacityCommand overrides
   wxString ManualPage() override {return L"Extra_Menu:_Scriptables_II#set_track";};
