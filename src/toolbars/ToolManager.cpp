...
static struct DefaultConfigEntry {
   ...
   { wxT("RecordMeter"),       wxT("Tools"),             {}                },
   { wxT("PlayMeter"),         wxT("RecordMeter"),       {}                },
   { wxT("Mixer"),             wxT("PlayMeter"),         {}                },
   { wxT("Edit"),              wxT("Mixer"),             {}                },
...
//
ToolBar *ToolManager::GetToolBar( Identifier type ) const
{
...
//
bool ToolManager::IsDocked( Identifier type )
{
