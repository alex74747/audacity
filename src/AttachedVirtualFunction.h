...
////////
// An override of the function is defined in SpecialClient.h,
...
////////
// Corresponding implementation in SpecialClient.cpp
...
////////
// A further override in ExtraSpecialClient.h, demonstrating call-through too
using DoSomethingExtraSpecial =
   DoSomething::Override< ExtraSpecialHost, DoSomethingSpecial >;

////////
// And in ExtraSpecialClient.cpp
// Unfortunately the strange looking "template<>" must be repeated as many
// times as the depth of the inheritance hierarchy
